...
public class PlayerManager implements IPlayController<TestAlbum, TestAlbum.TestMusic> {
    ...
    @Override
    public androidx.lifecycle.MutableLiveData<ChangeMusic> getChangeMusicLiveData() {
        return mController.getChangeMusicLiveData();
    }

    @Override
    public androidx.lifecycle.MutableLiveData<PlayingMusic> getPlayingMusicLiveData() {
        return mController.getPlayingMusicLiveData();
    }

    @Override
    public androidx.lifecycle.MutableLiveData<Boolean> getPauseLiveData() {
